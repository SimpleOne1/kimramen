...
export async function GET() {
  try {
    const categories = await getCached("catalog:categories:tree:ru", loadCategoryTree, {
      ttlMs: 5 * 60_000,
    ...
    await logAppError("GET /api/catalog/categories-tree", error);
